...
class OrderInformation(models.Model):
    ...
    tracking_number = models.CharField(max_length=20, null=True)
    ...
    cancel_reason = models.CharField(max_length=20, null=True)
    refund_status = models.CharField(max_length=20, null=True)
    ...
    order_complete_date = models.DateField(null=True)
